...
class Main:
	...
	def load_controllers(self):
		...
		self.path_controller = paths.Paths(self.BASE_DIR + "/res/config/paths.json", self.BASE_DIR)
	...
	def load_scripts(self):
		...
		self.graph_class = graphs.Graph(self.path_controller.get_path("DATA_CONFIG_PATH"))
		...
		self.thermal_video = read_data.Thermal_Video(self.path_controller.get_path("THERMAL_CONFIG_PATH"), self.path_controller.get_path("FILES_DATA"))
		self.maps = maps.Map()
...
class Script:
	...
	def __init__(self, graphs, videos, decrypt, read_data, thermal_video, maps):
